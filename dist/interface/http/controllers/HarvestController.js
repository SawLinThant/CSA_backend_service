...
const adminListHarvestsUseCase = new AdminListHarvestsUseCase_1.AdminListHarvestsUseCase(harvestRepository, farmerRepository, productRepository, userRepository);
