...
// @ts-nocheck 
/*
 * This file exports the `BoxVersion` model and its related types.
 *
...
export type GetBoxVersionAggregateType<T extends BoxVersionAggregateArgs> = {
      [P in keyof T & keyof AggregateBoxVersion]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBoxVersion[P]>
    : Prisma.GetScalarType<T[P], AggregateBoxVersion[P]>
}
...
type GetBoxVersionGroupByPayload<T extends BoxVersionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BoxVersionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BoxVersionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BoxVersionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BoxVersionGroupByOutputType[P]>
      }
    >
  >
...
export type BoxVersionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BoxVersionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BoxVersionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BoxVersion'], meta: { name: 'BoxVersion' } }
  /**
   ...
   * })
  **/
  count<T extends BoxVersionCountArgs>(
    args?: Prisma.Subset<T, BoxVersionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BoxVersionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BoxVersionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BoxVersionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBoxVersionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
